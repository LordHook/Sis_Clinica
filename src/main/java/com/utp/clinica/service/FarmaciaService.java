...
<<<<<<< HEAD
    ...
    /**
     * Elimina un medicamento del catálogo si no tiene recetas asociadas
     */
    @Transactional
    public void eliminarMedicamento(Integer id) {
        // Al intentar eliminar, si hay FK constraint fallará lanzando una excepción DataIntegrityViolationException.
